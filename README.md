...
| <a href="https://cvup.pro/en"><img src="./assets/projects/cvup.png" width="96" alt="CvUp" /></a> | **[CvUp ↗](https://cvup.pro/en)** · [ES ↗](https://cvup.pro) · [PT ↗](https://cvup.pro/pt-br)<br><br>AI-powered CV optimization tailored to each destination country's hiring conventions and ATS filters.<br><br>2,300+ CVs optimized · free scored diagnostic with one-time payment per optimization · country-specific rules for format, photo and tone · no AI training on user data, 30-day auto-deletion.<br><br>**Stack:** Next.js · React · NestJS · PostgreSQL · Redis · AI APIs |
